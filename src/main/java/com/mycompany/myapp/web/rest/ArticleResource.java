        ...
        Optional<Article> result = articleRepository
            ...
            .map(existingArticle -> {
                if (article.getModele() != null) {
                    existingArticle.setModele(article.getModele());
                }
                if (article.getLargeurPneus() != null) {
                    existingArticle.setLargeurPneus(article.getLargeurPneus());
                }
                if (article.getHauteurPneus() != null) {
                    existingArticle.setHauteurPneus(article.getHauteurPneus());
                }
                if (article.getTypePneus() != null) {
                    existingArticle.setTypePneus(article.getTypePneus());
                }
                if (article.getDiametre() != null) {
                    existingArticle.setDiametre(article.getDiametre());
                }
                if (article.getPhoto() != null) {
                    existingArticle.setPhoto(article.getPhoto());
                }
                if (article.getPhotoContentType() != null) {
                    existingArticle.setPhotoContentType(article.getPhotoContentType());
                }
