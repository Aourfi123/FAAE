...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './facture.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACTURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FACTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FACTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FACTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FACTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FACTURE actions', async () => {
      const expectedActions = [
        {
