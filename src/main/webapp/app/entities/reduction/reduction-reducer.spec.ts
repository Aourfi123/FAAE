...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './reduction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REDUCTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_REDUCTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REDUCTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REDUCTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REDUCTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REDUCTION actions', async () => {
      const expectedActions = [
        {
