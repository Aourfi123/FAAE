...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bordereau.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BORDEREAU_LIST actions', async () => {
    ...
    it('dispatches FETCH_BORDEREAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BORDEREAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BORDEREAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BORDEREAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BORDEREAU actions', async () => {
      const expectedActions = [
        {
