...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTBORDEREAU_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLIENTBORDEREAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLIENTBORDEREAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLIENTBORDEREAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTBORDEREAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLIENTBORDEREAU actions', async () => {
      const expectedActions = [
        {
