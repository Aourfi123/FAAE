...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './avoir.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AVOIR_LIST actions', async () => {
    ...
    it('dispatches FETCH_AVOIR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AVOIR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AVOIR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AVOIR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AVOIR actions', async () => {
      const expectedActions = [
        {
