...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './demande-rembourssement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEMANDEREMBOURSSEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEMANDEREMBOURSSEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEMANDEREMBOURSSEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEMANDEREMBOURSSEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEMANDEREMBOURSSEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEMANDEREMBOURSSEMENT actions', async () => {
      const expectedActions = [
        {
