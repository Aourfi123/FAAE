...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIGNESBORDEREAU_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIGNESBORDEREAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIGNESBORDEREAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIGNESBORDEREAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIGNESBORDEREAU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIGNESBORDEREAU actions', async () => {
      const expectedActions = [
        {
