...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DETAILSDEMANDE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DETAILSDEMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DETAILSDEMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DETAILSDEMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DETAILSDEMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DETAILSDEMANDE actions', async () => {
      const expectedActions = [
        {
