...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIGNESDOCUMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIGNESDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIGNESDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIGNESDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIGNESDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIGNESDOCUMENT actions', async () => {
      const expectedActions = [
        {
