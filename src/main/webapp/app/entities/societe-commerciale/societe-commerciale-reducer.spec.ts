...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './societe-commerciale.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIETECOMMERCIALE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOCIETECOMMERCIALE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOCIETECOMMERCIALE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOCIETECOMMERCIALE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOCIETECOMMERCIALE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOCIETECOMMERCIALE actions', async () => {
      const expectedActions = [
        {
